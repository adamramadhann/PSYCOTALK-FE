...
const Login = () => {
  ...
  return (
    <div className="w-screen min-h-screen bg-image sm:h-[100dvh] object-fill flex flex-col items-center justify-center p-3">
      ...
      <div className='bg-white/10 rounded-md flex flex-col items-center justify-center backdrop-blur-sm w-full space-y-5 max-w-3xl p-3' >
        <h1 className="text-[#540b03] font-bold text-center text-4xl mt-2">Medica</h1>
        ...
        <div className="w-full max-w-md mx-auto ">
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-5 mt-5">
            <label className="text-lg grid font-semibold text-white md:text-[#8D2C22] gap-2" htmlFor="email">
              Email
              <input onChange={handleChange} value={form.email} name='email' type="email" className="py-4 px-2 w-full text-base border-gray-200 border  rounded-lg text-[#8B302D] bg-white" placeholder="Enter your email" />
            </label>
